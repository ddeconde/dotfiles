...
# Link gpg files
require "dir" "${PRIVATE_DIR}/${PIP_DIR}" "${PRIVATE_DIR}/${PIP_DIR} not found"
if_not_exists "dir" "${HOME_DIR}/.${PIP_DIR}" "mkdir -p ${HOME_DIR}/.${PIP_DIR}"
link_files "${PRIVATE_DIR}/${PIP_DIR}" "${HOME_DIR}/.${PIP_DIR}"
